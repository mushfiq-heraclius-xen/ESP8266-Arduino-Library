...
class ESP8266WiFiMEGA
{
	...
	void startServer(String port,String timeOut);
	void deleteServer(void);
	void startSingleClient(String type,String addr,String port);
	void startMultipleClient(String id,String type,String addr,String port);
	void deleteAllClients(void);
	void send(String id,String s);
	void send(String s);
	void restart(void);
	void setSoftAPParameters(String ssid,String pwd,String ch,String ecn);
...
void ESP8266WiFiMEGA::startServer(String port,String timeOut)
{
	setCIPMUX(1);
	confirmAtCommand("OK",1200);
...
void ESP8266WiFiMEGA::startMultipleClient(String id,String type,String addr,String port)
{
	setCIPMUX(1);
	confirmAtCommand("OK",2000);
	String s ="";
...
void ESP8266WiFiMEGA::send(String id,String s)
{
	int len = s.length();
	String temp = "";
...
void ESP8266WiFiMEGA::setSoftAPParameters(String ssid,String pwd,String ch,String ecn)
{
	String s = "";
	s = s + "\"" + ssid + "\"" + "," + "\"" + pwd + "\"" + "," + ch + "," + ecn ;
	Serial2.println(s);
