...
void ESP8266WiFiUNO::startServer(String port,String timeOut)
{
	setCIPMUX(1);
	confirmAtCommand("OK",1200);
...
void ESP8266WiFiUNO::startMultipleClient(String id,String type,String addr,String port)
{
	setCIPMUX(1);
	confirmAtCommand("OK",2000);
	String s ="";
...
void ESP8266WiFiUNO::send(String id,String s)
{
	int len = s.length();
	String temp = "";
...
void ESP8266WiFiUNO::setSoftAPParameters(String ssid,String pwd,String ch,String ecn)
{
	String s = "";
	s = s + "\"" + ssid + "\"" + "," + "\"" + pwd + "\"" + "," + ch + "," + ecn ;
	esp8266wifi.println(s);
